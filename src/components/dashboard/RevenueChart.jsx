      ...
      <div className="mt-5 h-[260px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={revenueSeries} margin={{ top: 8, right: 8, bottom: 0, left: -10 }}>
            ...
            <CartesianGrid stroke="hsl(234 18% 16%)" strokeDasharray="3 6" vertical={false} />
            ...
            <Tooltip
              ...
              contentStyle={{ background: 'hsl(232 26% 8%)', border: '1px solid hsl(234 18% 16%)', borderRadius: 10, fontSize: 12, color: '#fff', boxShadow: '0 8px 30px -8px rgba(0,0,0,0.6)' }}
